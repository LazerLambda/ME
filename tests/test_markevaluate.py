...
class TestMarkEvaluate(unittest.TestCase):
    ...
    #     me = MarkEvaluate.MarkEvaluate(sent_transf=False, sntnc_lvl=True, orig=True, verbose=True)
    ...
    #         "The move is expected to delay the country's vaccination programme by several weeks."
    #     ]
    #     me = MarkEvaluate.MarkEvaluate(sent_transf=False, sntnc_lvl=True, orig=False, verbose=True)
    #     re = me.estimate(cand=s0, ref=s1)
    #     print(re)
